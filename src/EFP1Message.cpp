...
void const EFP1Message::print() const {
  ...
  std::cout << " RightFencerNation: " << (*this)[RightFencerNation]
            << std::endl;
  ...
  std::cout << " RightMedicalIntervention: "
            << (*this)[RightMedicalIntervention] << std::endl;
  std::cout << " RightReserveIntroduction: "
            << (*this)[RightReserveIntroduction] << std::endl;
  ...
  std::cout << " LeftMedicalIntervention: " << (*this)[LeftMedicalIntervention]
            << std::endl;
  std::cout << "LeftReserveIntroduction: " << (*this)[LeftReserveIntroduction]
            << std::endl;
