...
// Below are event definitions related to User Interface (leds, displays, ...
// keys, remote control, ...) Events generated by "input" devices e.g. keys,
// remote control, BLYNK io, ... (input towards the state machine) These are
// subtypes, The MS Byte is always 0x06 for a UI event, the LSB determines the
// event SUB_TYPE_MASK The 'middle' bytes can be used for data
...
// Machine Status: 'U' undefined; 'W' Waiting; 'H' Halted; 'F' Fencing; 'E'
// Ending; 'P' Paused; '5' Received NAK
...
#define EVENT_WS2812_UNDO_HIT 0x08080000 // low word: 0x0001=left, 0x0002=right
#define EVENT_WS2812_FLASH_SCORE                                               \
  0x08090000 // low word: 0x0001=left, 0x0002=right
