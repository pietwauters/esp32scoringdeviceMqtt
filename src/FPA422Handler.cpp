...
void FPA422Handler::StartWiFi() {
  ...
  ESP_LOGI(FPA422_TAG, "ESP32 IP as soft AP: %s",
  ...
  sprintf(LocalIPAddress, "%d.%d.%d.%d", localip[0], localip[1], localip[2],
          localip[3]);
...
/*void FPA422Handler::WifiTransmitMessage(int Type)
{
  ...
  if(m_WifiStarted)
  {
    ...
    {
      case 1:
      udp.broadcastTo(Message1.GetBuffer(),Message1.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_AP);
      //udp.broadcastTo(Message1.GetBuffer(),Message1.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_STA);

      break;

      case 2:
      udp.broadcastTo(Message2.GetBuffer(),Message2.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_AP);
      //udp.broadcastTo(Message2.GetBuffer(),Message2.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_STA);
      ...
      case 3:
      udp.broadcastTo(Message3.GetBuffer(),Message3.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_AP);
      //udp.broadcastTo(Message3.GetBuffer(),Message3.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_STA);
      ...
      case 4:
      udp.broadcastTo(Message4.GetBuffer(),Message4.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_AP);
      //udp.broadcastTo(Message4.GetBuffer(),Message4.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_STA);
      ...
      udp.broadcastTo(Message5.GetBuffer(),Message5.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_AP);
      //udp.broadcastTo(Message5.GetBuffer(),Message5.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_STA); break;

      case 6:

      udp.broadcastTo(Message6.GetBuffer(),Message6.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_AP);
      //udp.broadcastTo(Message6.GetBuffer(),Message6.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_STA);
      ...
      case 7:
      //udp.broadcastTo(Message7.GetBuffer(),Message7.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_AP);
      //udp.broadcastTo(MeMessage3ssage7.GetBuffer(),Message7.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_STA); break;

      case 8:
      udp.broadcastTo(Message8.GetBuffer(),Message8.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_AP);
      //udp.broadcastTo(Message8.GetBuffer(),Message8.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_STA);
      ...
      case 9:
      //udp.broadcastTo(Message9.GetBuffer(),Message9.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_AP);
      //udp.broadcastTo(Message9.GetBuffer(),Message9.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_STA); break;

      case 10:
      udp.broadcastTo(Message10.GetBuffer(),Message10.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_AP);
      //udp.broadcastTo(Message9.GetBuffer(),Message9.GetCurrentSize(),
UDPPort,TCPIP_ADAPTER_IF_STA);
...
void FPA422Handler::WifiTransmitMessage(int Type) {
  ...
  if (m_WifiStarted) {
    udp.broadcastTo(Meassages[Type - 1]->GetBuffer(),
