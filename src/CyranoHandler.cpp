...
std::string theMqttBroker = mdnsName; theMqttBroker += ".local";
...
if(false)
  ...
  mqttClient.publish(mqttPublishTopic, 0, true,TheJsonMessage.c_str(),TheJsonMessage.length());
  std::cout << "Cyrano message: " <<  TheMessage  << std::endl;
}
